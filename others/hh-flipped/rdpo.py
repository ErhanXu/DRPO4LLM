...
# RobustDPO training configuration
TRAINING_ARGS = DPOConfig(
    ...
    label_smoothing=0.1,  # RobustDPO typically doesn't use label smoothing - PLEASE CONFIRM
    ...
    output_dir="/root/autodl-tmp/selfmodel/RobustDPO_trained",
    # The trained model will be pushed to this repository on the Hub
    hub_model_id="Eehan/Qwen2.5-1.5B-rDPO-flip-hh",
    push_to_hub=True,
    save_strategy="no",
    report_to=["wandb"],
)
