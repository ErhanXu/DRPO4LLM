...
TRAIN_SCRIPT_ARGS = ScriptArguments(
    dataset_name="Eehan/train_data_tldr_flipped-10",  # Changed to TLDR dataset
...
TRAINING_ARGS = ORPOConfig(
    ...
    output_dir="/root/autodl-tmp/selfmodel/ORPO_tldr_trained",
    # The trained model will be pushed to this repository on the Hub
    hub_model_id="Eehan/pythia-1b-orpo-flip-tldr",
    push_to_hub=True,
    save_strategy="no",
    report_to=["wandb"],
)
...
GENERATION_BATCH_SIZE = 128  # From your pipeline code


# --- Part 1: Training Function ---
def train_model(model_args: ModelConfig, script_args: ScriptArguments, training_args: ORPOConfig):
    """
    Loads a base model, trains it using ORPOTrainer, and pushes it to the Hub.
    """
